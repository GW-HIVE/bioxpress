...
#samples <- data.frame(row.names=colnames(data3), condition=treat,type=subject)
#data4 <- DESeqDataSetFromMatrix(countData = data3, colData=samples,design=~condition+type)
#dds=DESeq(data4)
#ddsMF=dds
